...
{   
    ...
    void Awake()
    {
        playerOneName.text = variable.vPasser.playerName1;
        playerTwoName.text = variable.vPasser.playerName2;
        playerOneHP = variable.vPasser.Health;
        playerTwoHP = variable.vPasser.Health;
    }
    ...
    public void playerOneLowPunch()
    {
        ...
        StartCoroutine(delayProcess(1,73,1));
        Debug.Log("clack");
    }
    ...
    public void playerOneHighPunch()
    {
        ...
        attackSr.gameObject.GetComponent<VideoPlayer>().Play();
        StartCoroutine(delayProcess(1,50,2));
        Debug.Log("clack");
    }
    ...
    public void playerOneLowKick()
    {
        ...
        attackSr.gameObject.GetComponent<VideoPlayer>().Play();
        StartCoroutine(delayProcess(1,60,3));
        Debug.Log("clack");
    }
    ...
    public void playerOneHighKick()
    {
        ...
        attackSr.gameObject.GetComponent<VideoPlayer>().Play();
        StartCoroutine(delayProcess(1,40,4));
        Debug.Log("clack");
    }
    ...
    public void playerOneSpecial()
    {
        ...
        attackSr.gameObject.GetComponent<VideoPlayer>().Play();
        StartCoroutine(delayProcess(1,80,5));
    ...
    public void playerTwoLowPunch()
    {
        ...
        attackSr.gameObject.GetComponent<VideoPlayer>().Play();
        StartCoroutine(delayProcess(2,70,1));
        Debug.Log("clack");
    }
    ...
    public void playerTwoHighPunch()
    {
        ...
        attackSr.gameObject.GetComponent<VideoPlayer>().Play();
        StartCoroutine(delayProcess(2,50,2));
        Debug.Log("clack");
    }
    ...
    public void playerTwoLowKick()
    {
        ...
        attackSr.gameObject.GetComponent<VideoPlayer>().Play();
        StartCoroutine(delayProcess(2,60,3));
        Debug.Log("clack");
    }
    ...
    public void playerTwoHighKick()
    {
        ...
        attackSr.gameObject.GetComponent<VideoPlayer>().Play();
        StartCoroutine(delayProcess(2,40,4));
        Debug.Log("clack");
    }
    ...
    public void playerTwoSpecial()
    {
        ...
        attackSr.gameObject.GetComponent<VideoPlayer>().Play();
        StartCoroutine(delayProcess(2,80,5));
